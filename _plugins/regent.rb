  ...
  module Lexers
    class Regent < Lua
      ...
      state :base do
        ...
        # Regent syntax:
        rule %r([@]), Operator
        rule %r((__demand|__parallel|atomic|aliased|copy|complete|disjoint|equal|exclusive|fill|image|import|incomplete|new|null|preimage|reads|reduces|relaxed|rexpr|rquote|simultaneous|where|writes)\b), Keyword
